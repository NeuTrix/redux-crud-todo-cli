...
.end(function(err, res){
  res.body.should.have.property('x-foo', 'bar');
            ...
            <dd><pre><code>request
.post('http://localhost:8080/header')
.type('txt')
.set('X-Foo', 'bar')
.set('X-Bar', 'baz')
.send('hey')
...
.end(function(err, res){
  ...
  res.headers.query.should.eql('{}');
            ...
            <dd><pre><code>request
.get('http://localhost:8080/bad-redirect')
.end(function(err, res){
  err.message.should.equal('No location header for redirect');
            ...
            <section class="suite">
              ...
              <dl>
                ...
                <dd><pre><code>var redirects = [];
request
.get('http://localhost:8080/relative')
.on('redirect', function(res){
  redirects.push(res.headers.location);
})
.end(function(err, res){
  ...
  res.text.should.equal('tobi');
                ...
                <dd><pre><code>var redirects = [];
request
.get('http://localhost:8080/relative/sub')
.on('redirect', function(res){
  redirects.push(res.headers.location);
})
.end(function(err, res){
  ...
  res.text.should.equal('first movie page');
        ...
        <section class="suite">
          ...
          <dl>
            ...
            <dd><pre><code>request
.put('http://localhost:8080/redirect-303')
.send({msg: &quot;hello&quot;})
.redirects(1)
.on('redirect', function(res) {
  ...
  res.text.should.equal('method=get');
        ...
        <section class="suite">
          ...
          <dl>
            <dt>should redirect with same method</dt>
            <dd><pre><code>request
.put('http://localhost:8080/redirect-307')
.send({msg: &quot;hello&quot;})
.redirects(1)
.on('redirect', function(res) {
  res.headers.location.should.equal('/reply-method')
  ...
  res.text.should.equal('method=put');
        ...
        <section class="suite">
          ...
          <dl>
            <dt>should redirect with same method</dt>
            <dd><pre><code>request
.put('http://localhost:8080/redirect-308')
.send({msg: &quot;hello&quot;})
.redirects(1)
.on('redirect', function(res) {
  res.headers.location.should.equal('/reply-method')
